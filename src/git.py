...
def Commit():
    ...
    if commit_message.count('`'):
        issues.warning('\033[m\033[1m`\033[m\033[91m is not acceptable in this mode.')
        if confirm('Replace \033[m\033[1m`\033[m\033[96m with \033[m\033[1m\'\033[m\033[96m'):
            commit_message = commit_message.replace('`', "'")
            issues.warning('\033[m\033[1m`\033[m\033[91m is now replaced with \033[m\033[1m\'\033[91m...')
        else:
